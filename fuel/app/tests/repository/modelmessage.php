...
class Repository_ModelmessageTest extends PHPUnit_Extensions_Database_TestCase
{
    ...
    {
        $result = Repository_Modelmessage::message_find_by_userId_desc_by_createdAt(1);
    ...
    {
        $result = Repository_Modelmessage::message_find_all();
        $expect = count($result);
    ...
    {
        $result = Repository_Modelmessage::message_find_by_mention_desc_by_createdAt(1);
